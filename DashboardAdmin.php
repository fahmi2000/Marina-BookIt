    ...
    <div class="wrapper">
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <div id="profileBtn" style="padding-top: 3rem">
                    <a class="btn btn-outline-dark btn-block" href="ProfileUser.php" role="button"><i class="fas fa-user-circle"></i>#PLACEHOLDER_USERNAME#</i></a>
                </div>
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                <button type="button" id="sidebarCollapse" class="btn btn-dark float-left">
                    <i class="fas fa-indent"></i>
                </button>
            </nav>
            <h2>Hello, #PLACEHOLDER_USERNAME#</h2>
